...
const ButtonLink = styled__default(Button).withConfig({
...
const ActionButton = styled__default(ButtonSwap).withConfig({
...
const Check = styled__default(BaseCheck).withConfig({
...
const Buttons = styled__default.div.withConfig({
  displayName: "ResizeBar__Buttons"
})(["display:flex;background:", ";border:1px solid ", ";border-radius:", ";padding:3px 5px;"], __chunk_1.get('colors.background'), __chunk_1.get('colors.border'), __chunk_1.get('radii'));
const ResizeBar = ({
  onChangeSize
...
const Actions = styled__default.div.withConfig({
  displayName: "ActionsBar__Actions"
})(["display:flex;justify-content:flex-end;padding:0 5px;background:", ";"], getActionsBg);
const actionStyle = styled.css(["padding:3px 10px;border-left:1px solid ", ";"], borderColor);
const Action = styled__default(ActionButton).withConfig({
  displayName: "ActionsBar__Action"
})(["", ";"], actionStyle);
const Clipboard = styled__default(ClipboardAction).withConfig({
...
const line = position => p => styled.css(["content:'';position:absolute;display:block;top:", ";left:", ";width:", ";height:", ";background:", ";transform:translate(-50%,-50%);"], p.horizontal ? '50%' : position, p.horizontal ? position : '50%', p.horizontal ? '2px' : '25px', p.horizontal ? '25px' : '2px', getLineBackground);

const whenHorizontal = (on, off) => p => p.horizontal ? on : off;

const handleHeight = p => p.horizontal ? `calc(100% ${p.full ? '+ 3px' : '- 2px'})` : HANDLE_SIZE;

const Handle = styled__default.div.withConfig({
  displayName: "Handle"
...
const CodeMirror = loadable(() => Promise.resolve(require('./chunk2.js')));
...
const Wrapper$1 = styled__default.div.withConfig({
  displayName: "Editor__Wrapper"
})(["margin:30px 0;position:relative;width:100%;border:1px solid ", ";"], __chunk_1.get('colors.border'));
const Actions$1 = styled__default.div.withConfig({
...
const Overlay = styled__default.div.withConfig({
...
const PreviewWrapper = styled__default.div.withConfig({
...
const StyledPreviewWrapper = styled__default.div.withConfig({
  displayName: "Playground__StyledPreviewWrapper"
})(["position:relative;box-sizing:border-box;width:100%;", ";"], __chunk_1.get('styles.playground'));
const StyledError = styled__default(reactLive.LiveError).withConfig({
...
const Pre = styled__default(Editor).withConfig({
...
const editorStyle = styled.css(["border-top:0;"]);
...
const Blockquote = styled__default.blockquote.withConfig({
  displayName: "Blockquote"
})(["background:", ";border-left:5px solid ", ";color:", ";", ";& > p{margin:0;color:", ";}"], __chunk_1.get('colors.blockquoteBg'), __chunk_1.get('colors.blockquoteBorder'), __chunk_1.get('colors.blockquoteColor'), __chunk_1.get('styles.blockquote'), __chunk_1.get('colors.blockquoteColor'));

const H1 = styled__default.h1.withConfig({
  displayName: "H1"
})(["", ";"], __chunk_1.get('styles.h1'));

const Icon = styled__default(Hash).withConfig({
  displayName: "H2__Icon"
})(["position:absolute;display:inline-block;top:11px;left:-28px;opacity:0;transition:opacity 0.2s;color:", ";"], __chunk_1.get('colors.primary'));
const Heading = styled__default.h2.withConfig({
  displayName: "H2__Heading"
})(["position:relative;&:hover .heading--Icon{opacity:1;}", ";"], __chunk_1.get('styles.h2'));
const H2 = _a => {
  var {
    children
  } = _a,
...
const H3 = styled__default.h3.withConfig({
  displayName: "H3"
})(["", ";"], __chunk_1.get('styles.h3'));

const H4 = styled__default.h4.withConfig({
  displayName: "H4"
})(["", ";"], __chunk_1.get('styles.h4'));

const H5 = styled__default.h5.withConfig({
  displayName: "H5"
})(["", ";"], __chunk_1.get('styles.h5'));

const H6 = styled__default.h6.withConfig({
  displayName: "H6"
})(["", ";"], __chunk_1.get('styles.h6'));

const Hr = styled__default.hr.withConfig({
  displayName: "Hr"
})(["border:none;border-top:1px dashed ", ";margin:40px 0;", ";"], __chunk_1.get('colors.border'), __chunk_1.get('styles.hr'));

const InlineCode = styled__default.code.withConfig({
  displayName: "InlineCode"
})(["background:", ";color:", ";", ";"], __chunk_1.get('colors.codeBg'), __chunk_1.get('colors.codeColor'), __chunk_1.get('styles.code'));

const LinkStyled = styled__default.a.withConfig({
  displayName: "Link__LinkStyled"
})(["&,&:visited,&:active{text-decoration:none;color:", ";}&:hover{color:", ";}", ";"], __chunk_1.get('colors.link'), __chunk_1.get('colors.link'), __chunk_1.get('styles.link'));
const Link = _a => {
  var {
    href
  } = _a,
  ...
  const toCheck = React.useMemo(() => [location.pathname.split(separator).slice(0, -1).join(separator).slice(1), (href || '').replace(/^(?:\.\/)+/gi, '')].join('/'), [separator]);
...
const Wrapper$3 = styled__default.div.withConfig({
...
const Lines = styled__default.path.withConfig({
  displayName: "Loading__Lines"
})(["stroke:", ";stroke-width:3px;"], __chunk_1.get('colors.primary'));
const Path = styled__default.path.withConfig({
...
const octocatWave = styled.keyframes(["0%,100%{transform:rotate(0);}20%,60%{transform:rotate(-25deg);}40%,80%{transform:rotate(10deg);}"]);
const Link$1 = styled__default.a.withConfig({
...
const Svg = styled__default.svg.withConfig({
  displayName: "GithubLink__Svg"
})(["z-index:99;fill:", ";color:", ";position:absolute;top:0;border:0;right:0;"], __chunk_1.get('colors.primary'), __chunk_1.get('colors.background'));
const GithubLink = ({
  repository
...
const Wrapper$4 = styled__default.div.withConfig({
  displayName: "Logo__Wrapper"
})(["position:relative;display:flex;flex-direction:column;align-items:flex-start;justify-content:center;padding:24px;a,a:hover,a:visited{text-decoration:none;}&:before{position:absolute;content:'';top:0;left:0;width:100%;height:3px;background:", ";}@media screen and (max-width:", "px){&:before{height:", ";}}", ";"], p => sidebarPrimary(p) || primaryColor(p), breakpoints.desktop, p => p.showBg ? '3px' : 0, __chunk_1.get('styles.logo'));
const LogoImg = styled__default('img').withConfig({
  displayName: "Logo__LogoImg"
})(["padding:0;margin:5px 0;"]);
const LogoText = styled__default('h1').withConfig({
  displayName: "Logo__LogoText"
})(["margin:5px 0;font-size:24px;font-weight:600;letter-spacing:-0.015em;color:", ";"], __chunk_1.get('colors.sidebarText'));
const Logo = ({
  showBg
}) => {
  const {
...
const Wrapper$5 = styled__default.div.withConfig({
...
const Icon$1 = styled__default(SearchIcon).withConfig({
...
const Submenu = styled__default.div.withConfig({
...
const activeWrapper = styled.css(["padding-left:0;&:after{width:1px;}"]);
const Wrapper$6 = styled__default.div.withConfig({
  displayName: "MenuLink__Wrapper"
})(["position:relative;transition:padding 0.2s;&:after{position:absolute;display:block;content:'';top:30px;left:24px;width:0;height:calc(100% - 36px);border-left:1px dashed ", ";transition:width 0.2s;}", ";"], __chunk_1.get('colors.sidebarBorder'), p => p.active && activeWrapper);
const createLink = Link => styled__default(Link).withConfig({
  displayName: "MenuLink__createLink"
})(["position:relative;display:block;padding:4px 24px;font-weight:600;font-size:18px;letter-spacing:-0.02em;color:", ";text-decoration:none;transition:color 0.2s;&:hover,&:visited{color:", ";}&:hover,&.active{color:", ";font-weight:600;}"], __chunk_1.get('colors.sidebarText'), __chunk_1.get('colors.sidebarText'), p => __chunk_1.get('colors.sidebarPrimary')(p) || __chunk_1.get('colors.primary')(p));
const LinkAnchor = createLink(styled__default.a.withConfig({
...
const Wrapper$7 = styled__default.div.withConfig({
  displayName: "Menu__Wrapper"
})(["display:flex;flex-direction:column;"]);
const List = styled__default.dl.withConfig({
...
const Icon$2 = styled__default.div.withConfig({
  displayName: "Menu__Icon"
})(["position:absolute;top:50%;right:20px;transform:translateY(-50%) rotate(", ");transform-origin:50% 50%;transition:transform 0.3s;& svg{stroke:", ";}"], iconRotate, __chunk_1.get('colors.sidebarText'));
const Menu = props => {
...
const Icon$3 = styled__default.div.withConfig({
...
const IconLine = styled__default.span.withConfig({
...
const ToggleButton = styled__default.button.withConfig({
...
const Wrapper$8 = styled__default.div.withConfig({
...
}), breakpoints.desktop - 1, p => p.opened ? '-100%' : '0', p => p.opened ? 'auto' : 'fixed', __chunk_1.get('styles.sidebar'));
...
const FooterLink = styled__default.a.withConfig({
  displayName: "Sidebar__FooterLink"
})(["padding:0;margin:0;margin-left:5px;"]);
const FooterLogo = styled__default(Docz).withConfig({
  displayName: "Sidebar__FooterLogo"
})(["fill:", ";"], sidebarText$2);
const ToggleBackground = styled__default.div.withConfig({
...
const Wrapper$9 = styled__default.div.withConfig({
  displayName: "NotFound__Wrapper"
})(["display:flex;align-items:center;justify-content:center;flex-direction:column;width:100%;height:100vh;color:", ";background:", ";"], __chunk_1.get('colors.text'), __chunk_1.get('colors.background'));
const Title = styled__default.h1.withConfig({
  displayName: "NotFound__Title"
})(["margin:0;font-size:42px;font-weight:400;color:", ";"], __chunk_1.get('colors.primary'));
const Subtitle = styled__default.p.withConfig({
...
const OrderedList = styled__default.ol.withConfig({
...
const EditPage = styled__default(ButtonLink.withComponent('a')).withConfig({
  displayName: "Page__EditPage"
})(["display:flex;align-items:center;justify-content:center;position:absolute;padding:2px 8px;margin:8px;border-radius:", ";border:1px solid ", ";opacity:0.7;transition:opacity 0.4s;font-size:14px;color:", ";text-decoration:none;text-transform:uppercase;&:hover{opacity:1;background:", ";}", ";"], __chunk_1.get('radii'), __chunk_1.get('colors.border'), __chunk_1.get('colors.text'), __chunk_1.get('colors.border'), mq({
  visibility: ['hidden', 'hidden', 'visible'],
  top: [0, -60, 32],
  right: [0, 0, 40]
}));
const EditIcon = styled__default(Edit).withConfig({
...
})(["color:", ";", ";"], __chunk_1.get('colors.text'), __chunk_1.get('styles.paragraph'));

const Pre$1 = props => React.createElement(Editor, Object.assign({}, props));

const Wrapper$b = styled__default.div.withConfig({
  displayName: "PropsRaw__Wrapper"
})(["display:flex;flex-direction:column;& ~ &{margin-top:20px;}"]);
const Title$1 = styled__default.div.withConfig({
  displayName: "PropsRaw__Title"
})(["display:flex;border-bottom:1px solid ", ";"], __chunk_1.get('colors.propsBg'));
const PropName = styled__default.span.withConfig({
  displayName: "PropsRaw__PropName"
})(["background:", ";color:", ";padding:5px 10px;border-radius:4px 4px 0 0;font-size:16px;font-weight:500;& ~ &{margin-left:5px;}"], __chunk_1.get('colors.propsBg'), __chunk_1.get('colors.primary'));
const PropType = styled__default(PropName).withConfig({
  displayName: "PropsRaw__PropType"
})(["color:", ";background:", ";font-weight:400;"], __chunk_1.get('colors.propsText'), __chunk_1.get('colors.propsBg'));
const PropDefaultValue = styled__default(PropType).withConfig({
  displayName: "PropsRaw__PropDefaultValue"
})(["background:transparent;padding-left:0;padding-right:0;"]);
const PropRequired = styled__default(PropType).withConfig({
...
})(["border:1px solid ", ";border-radius:4px;overflow:hidden;background:", ";color:", ";"], __chunk_1.get('colors.border'), __chunk_1.get('colors.propsBg'), __chunk_1.get('colors.propsText'));
const Line = styled__default.div.withConfig({
  displayName: "PropsTable__Line"
})(["padding:8px 0;@media (min-width:", "){padding:O;}& + &{border-top:1px solid ", ";}"], breakpoint, __chunk_1.get('colors.border'));
const Column = styled__default.div.withConfig({
...
const ColumnName = styled__default(Column).withConfig({
  displayName: "PropsTable__ColumnName"
})(["@media (min-width:", "){flex-basis:25%;}"], breakpoint);
const ColumnType = styled__default(Column).withConfig({
  displayName: "PropsTable__ColumnType"
})(["@media (min-width:", "){flex-basis:50%;}"], breakpoint);
const ColumnValue = styled__default(Column).withConfig({
  displayName: "PropsTable__ColumnValue"
})(["@media (min-width:", "){flex-basis:25%;}"], breakpoint);
const Content$1 = styled__default.div.withConfig({
  displayName: "PropsTable__Content"
})(["display:flex;flex-direction:column;font-family:", ";@media (min-width:", "){flex-wrap:nowrap;flex-direction:row;}"], __chunk_1.get('fonts.mono'), breakpoint);
const PropName$1 = styled__default.span.withConfig({
  displayName: "PropsTable__PropName"
})(["color:", ";font-weight:bold;"], __chunk_1.get('colors.primary'));
const PropType$1 = styled__default.span.withConfig({
  displayName: "PropsTable__PropType"
})(["font-size:0.9em;"]);
const PropDefaultValue$1 = styled__default.span.withConfig({
  displayName: "PropsTable__PropDefaultValue"
})(["font-size:0.9em;"]);
const PropRequired$1 = styled__default.span.withConfig({
...
const Props = _a => {
  ...
  const components = docz.useComponents();
  const Title = React.useMemo(() => styled__default(components.H3 || 'h3').withConfig({
...
const TableStyled = styled__default.table.withConfig({
  ...
  width: ['20%', '20%', '20%', 'auto']
}), __chunk_1.get('colors.border'), __chunk_1.get('styles.table'));
const Table = props => React.createElement(Wrapper$c, null, React.createElement(TableStyled, Object.assign({}, props)));

const UnorderedList = styled__default.ul.withConfig({
  displayName: "UnorderedList"
})(["list-style:none;& li::before{content:'\u25CF ';color:", ";font-weight:bold;font-size:0.5em;margin-right:5px;}", ";ul li{padding-left:25px;}"], __chunk_1.get('colors.border'), __chunk_1.get('styles.ul'));
...
const styles = {
  body: styled.css(["font-family:", ";font-size:16px;line-height:1.6;"], __chunk_1.get('fonts.ui')),
  h1: styled.css(["margin:40px 0 20px;font-family:", ";font-size:48px;font-weight:600;letter-spacing:-0.02em;"], __chunk_1.get('fonts.display')),
  h2: styled.css(["margin:30px 0 15px;line-height:1.4em;font-family:", ";font-weight:500;font-size:28px;letter-spacing:-0.02em;"], __chunk_1.get('fonts.display')),
  h3: styled.css(["margin:25px 0 10px;font-size:20px;font-weight:400;"]),
  h4: styled.css(["margin:25px 0 10px;font-size:16px;font-weight:400;"]),
  h5: styled.css(["margin:20px 0 10px;font-size:16px;font-weight:400;"]),
  h6: styled.css(["margin:20px 0 10px;font-size:16px;font-weight:400;text-transform:uppercase;"]),
  ol: styled.css(["padding:0;margin:10px 0 10px;"]),
  ul: styled.css(["padding:0;margin:10px 0 10px;"]),
  playground: styled.css(["padding:40px;"]),
  code: styled.css(["margin:0 3px;border-radius:3px;font-family:", ";padding:2px 5px;font-size:0.8em;border:'1px solid rgba(0, 0, 0, 0.02)';"], __chunk_1.get('fonts.mono')),
  pre: styled.css(["font-family:", ";font-size:1em;line-height:1.8;"], __chunk_1.get('fonts.mono')),
  paragraph: styled.css(["margin:10px 0 20px 0;"]),
  table: styled.css(["overflow-y:hidden;width:100%;font-family:", ";font-size:16px;overflow-x:initial;display:block;"], __chunk_1.get('fonts.mono')),
  blockquote: styled.css(["margin:25px 0;padding:20px;font-style:italic;font-size:16px;"])
};
